...
def test_load_history(mock_exists, mock_read_csv, calculator):
    ...
    try:
        ...
        assert calculator.history[0].first_operand == Decimal("2")
        assert calculator.history[0].second_operand == Decimal("3")
...
def test_get_history_dataframe(calculator):
    ...
    assert 'first_operand' in df.columns
    assert 'second_operand' in df.columns
