...
@pytest.mark.parametrize("operation_class, a, b, expected", [
    (Addition, Decimal('2.5'), Decimal('3.5'), Decimal('6.0')),
    (Subtraction, Decimal('5.0'), Decimal('2.0'), Decimal('3.0')),
    (Multiplication, Decimal('2.0'), Decimal('3.0'), Decimal('6.0')),
    (Division, Decimal('6.0'), Decimal('2.0'), Decimal('3.0')),
    (Power, Decimal('2.0'), Decimal('3.0'), Decimal('8.0')),
    (Root, Decimal('27.0'), Decimal('3.0'), Decimal('3.0')),
])
def test_operations(operation_class: Type[Operation], a: Decimal, b: Decimal, expected: Decimal):
